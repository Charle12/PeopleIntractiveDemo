...
public class Spinner: UIView {
   // MARK: - Singleton
    ...
    private static func containerView() -> UIView? {
        ...
        return customSuperview ?? keyWindow
        #endif
    }
    ...
    @discardableResult
    public class func show(_ title: String, animated: Bool = true) -> Spinner {
        ...
        if spinner.superview == nil {
            ...
            spinner.delay(0.33) { Spinner.show(title, animated: animated) }
        }
    ...
    /// - Returns: The instance of the spinner
    @discardableResult
    public class func show(duration: Double, title: String, animated: Bool = true) -> Spinner {
    ...
    public class func show(delay: Double, title: String, animated: Bool = true) {
        ...
        Spinner.sharedInstance.delay(delay, completion: {
    ...
    /// - Returns: The instance of the spinner
    @discardableResult
    public class func show(progress: Double, title: String) -> Spinner {
    ...
    @objc public func updateFrame() {
        if let containerView = Spinner.containerView() {
            ...
            containerView.bringSubviewToFront(Spinner.sharedInstance)
        }
    }
